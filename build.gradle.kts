...
application {
    ...
    mainClass.set("org.matita08.VisionMC.VisionBots")
}
...
val fatJar = task("fatJar", type = Jar::class) {
    ...
    manifest {
        attributes["Implementation-Title"] = "VisionBots"
        attributes["Implementation-Version"] = version
        attributes["Main-Class"] = "org.matita08.VisionMC.VisionBots" // Same mainclass as the application plugin setting
    }
